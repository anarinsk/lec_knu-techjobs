...
:::{.notes}
제가 IT 회사에서 필요한 인재상, 이런 걸 딱 정해서 말씀 드릴 수 있다면 좋을 것입니다. 하지만 저는 그런게 있는지 잘 모르겠습니다. 아직 경험이 부족해서 그런지 모르겠지만, 그렇습니다. 그래서 이 프로그램의 다른 연사 분들을 쭉 봤는데요. 저보다 훨씬 훌륭하고 이런 건 말씀해주실 수 있는 분들이더라고요. 그래서 저는 조금 다른 방향에서 여러 분에게 아주 작은 도움이나마 드릴 수 있는 내용이 무엇인지 고민해 보았습니다. 혹시라도 오늘 제 이야기가 도움이 되지 않는다면 그냥 무시하시고 앞으로 나아가시면 됩니다. 조금이라도 도음이 된다면 제가 감사할 일입니다. 
:::
