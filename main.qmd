...
- [내용과 소스](https://github.com/anarinsk/lec_knu-techjobs/)는 모두 공개되어 있습니다. 
- 발표 자료는 Revealjs + Quarto를 통해 만들었습니다. 
- 등장하는 이미지는 대체로 DALLE-3를 통해 생성되었습니다. 
:::

## On Speaker {.center .smaller}
:::{.nonincremental}
- 경제학 박사  
...
:::{layout=[-1,20,-1] style="font-size: 1.3em;"}
"오늘 제가 떠드는 말이 얼마나 도움이 될까요?"
:::
...
:::{layout="[5, -0.2, 5]"}
![계산능력 vs 효과. GO [🔗](https://ourworldindata.org/grapher/ai-performance-knowledge-tests-vs-training-computation)](images/ai-performance-knowledge-tests-vs-training-computation.png)

![시기 별 계산 능력의 변화 GO [🔗](https://ourworldindata.org/grapher/artificial-intelligence-training-computation)](images/artificial-intelligence-training-computation.png)
:::
...
#### Advanced Data Analysis. GO [🔗](https://youtu.be/SzTjGAO6fKo?t=220)
:::{layout="[-1,1,-1]"}
...
#### 여러 분의 회화 선생님. GO [🔗](https://youtu.be/4dDkUxR7dIE?t=261)
:::{layout="[-1,0.5,-1]"}
...
#### Python in Excel 2. GO [🔗](https://support.microsoft.com/ko-kr/office/excel%EC%9D%98-python-%EC%86%8C%EA%B0%9C-55643c2e-ff56-4168-b1ce-9428c8308545)
:::{layout="[-1,3,-1]"}
